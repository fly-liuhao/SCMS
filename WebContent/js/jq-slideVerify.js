(function(global, factory) {
	...
	var inlineCss = '*{margin:0;padding:0;box-sizing:border-box}.verify-wrap{width:318px;height:38px;background-color:#e5e5e5;border:1px solid #e0e0e0;margin:5px auto;position:relative}.verify-wrap .drag-btn{position:absolute;left:-1px;top:-1px;width:50px;height:38px;background:#fff url(data:image/png;base64,) no-repeat center center;background-size:100% 100%;z-index:2;cursor:move;}.verify-wrap .suc-drag-btn{position:absolute;left:1px;top:-1px; background:#fff url(images/suc-drag-btn.png) no-repeat center center;background-size:100% 100%}.verify-wrap .drag-progress{position:absolute;left:0;top:-1px;height:38px;border-top:1px solid #93d3fb;border-top:1px solid #93d3fb;width:0;background-color:#93d3fb;color:#fff;font-size:18px;text-align:center;line-height:38px}.verify-wrap .fix-tips,.verify-msg{width:100%;position:absolute;right:0;left:1px;height:100%;color:#51555c;z-index:1;line-height:38px;font-size:12px;text-align:center}.verify-wrap .verify-msg{background-color:#93d3fb;color:#fff;display:none}';
	var styleObj = $(
